...
interface SelectExportProps {
  onclick_details: () => void; // Função para abrir o modal
  onClose_details: () => void; // Função para fechar o modal
}

export default function SelectExport({ onclick_details, onClose_details }: SelectExportProps) {
