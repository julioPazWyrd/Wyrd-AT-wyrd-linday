...
import { IoSearch, IoSearchOutline } from "react-icons/io5"; // Ícones de zoom
import Image from "next/image";

interface DetalhesMaquinaProps {
    isOpen: boolean;
    onClose: () => void;
}

export default function DetalhesMaquina({ isOpen, onClose }: DetalhesMaquinaProps) {
    useEffect(() => {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50" onClick={handleBackdropClick}>
            ...
            >
                ...
                <div className="w-full flex justify-center">
                    <Image
                        src="/details.png" // Substituir com a imagem correta
                ...
                <div className="w-full pr-2 flex">
                    ...
                    <div className="w-1/2 flex justify-end gap-3 ">
                        <button className="text-white hover:text-gray-400" aria-label="Zoom Out">
                            <IoSearchOutline size={20} />
                        </button>
                        <button className="text-white hover:text-gray-400" aria-label="Zoom In">
                            <IoSearch size={20} />
                        </button>
                    </div>
                </div>
                ...
                <div className="w-full mt-6 text-sm flex justify-between items-center">
                    <div className=" border-r p-2 w-1/2 flex-row flex justify-between items-center">
                        <div className="w-full flex justify-between items-center">
                            ...
                            <span className="bg-[#FFE0E5] text-[#E83838] border-[#E83838] border px-2 py-1 rounded-full text-center">
                                Não resolvido
                            </span>
                        </div>
                    </div>

                    <div className="w-1/2 flex-row flex justify-between items-center p-2">
                        <div></div>
                        <div>
